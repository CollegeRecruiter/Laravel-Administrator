...
class BelongsTo extends Relationship {
	...
	public function build()
	{
		...
		$relevantName = $nested['pieces'][sizeof((array) $nested['pieces'])-1];
		$relevantModel = $nested['models'][sizeof((array) $nested['models'])-2];
	...
	public function getNestedRelationships($name)
	{
		$pieces = explode('.', $name);
		$models = array();
		$num_pieces = sizeof((array) $pieces);
	...
	public function filterQuery(&$selects)
	{
		...
		$num_pieces = sizeof((array) $nested['pieces']);
